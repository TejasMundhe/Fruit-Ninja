...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage, knifecut, bombSound;
...
function preload(){
  ...
  knifecut = loadSound("knifeSound.mp3");
...
function draw() {
  ...
  if(gameState === END){
    textSize(38);
    text("Press r to play again", 140, 440);
    if(keyDown("r")){
      knife.addImage(knifeImage);
      knife.scale = 0.5;
      score = 0;
